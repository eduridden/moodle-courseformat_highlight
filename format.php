 ...
 * @highlight additions by Julian Ridden (http://www.moodleman.net)
...
$PAGE->requires->js('/course/format/highlight/js/utilities.js');
$PAGE->requires->js('/course/format/highlight/js/yuilight.js');
...
echo get_string('instructions', 'format_highlight');
echo "</div>";
...
if ($thissection->summary or $thissection->sequence or $PAGE->user_is_editing()) {
    ...
    echo '<div class="yuilight"><div class="left side">&nbsp;</div>';
...
while ($section <= $course->numsections) {
    ...
    if ($showsection) {
        ...
        echo '<li id="section-'.$section.'" class="section main clearfix'.$sectionstyle.'" >'; //'<div class="left side">&nbsp;</div>';
            ...
            echo '<div class="yuilight"><div class="left side">'.$currenttext.$section.'</div>';
        // Note, 'right side' is BEFORE content.
